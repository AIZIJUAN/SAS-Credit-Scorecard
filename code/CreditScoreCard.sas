...
/* Variable : CIDF     *****/
/*********************************************/
      IF CIDF = "" THEN  Points=Points +(0);
      IF CIDF = "" THEN  Points=Points +(-8);
/*********************************************/
/* Variable : CSFF     *****/
/*********************************************/
      IF CSFF = "" THEN  Points=Points +(21);
      IF CSFF = "" THEN  Points=Points +(-1);
/*********************************************/
/* Variable : CSPF     *****/
/*********************************************/
      IF CSPF = "" THEN  Points=Points +(2);
      IF CSPF = "" THEN  Points=Points +(-29);
/*********************************************/
/* Variable : DTF     *****/
/*********************************************/
      IF DTF = "" THEN  Points=Points +(23);
      IF DTF = "" THEN  Points=Points +(-3);
/*********************************************/
/* Variable : GENDER     *****/
/*********************************************/
